...
def process(parser_path, save_path, data, output_path):
    ...
    #parse the file
    parse_uml(parser_path, seq_path)
...
def parse_uml(parser_path, input_path):
    ...
    #exclude the ".java" before parse
    input_path = input_path[:-5]
    subprocess.call([parser_path, input_path, "png"])
